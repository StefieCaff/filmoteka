...
// const paginationBoxQueue = document.querySelector('.pagination-library-container-queue');

// paginationBoxQueue.addEventListener('click', handlerLocalPaginationQueue);
...
// export default function localPaginationQueue(allQueueMovies, currentPage) {
//     // console.log(currentPage, "init");
...
//   paginationBoxQueue.innerHTML = markup;
// }

// let currentPage = 1;

// function handlerLocalPaginationQueue(evt) {
//   console.log(currentPage, "init");
...
//   localPaginationQueue(Object.keys(localMovies).length, page);
